...
// <<<<<<<< start_thread >>>>>>>>
bool pthreads_class::start_thread() { return (pthread_create(&thread, NULL, run_helper, this) == 0); } // end start_thread

// <<<<<<<< wait >>>>>>>>
void pthreads_class::wait() { (void) pthread_join(thread, NULL); } // end wait
